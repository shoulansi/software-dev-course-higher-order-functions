...
*/
function filterProducts(products, testFunction) {
  return products.filter(testFunction);
}
let inStockProducts = filterProducts(products, product => product.inStock);
/*
...
console.log("Total value in stock:", productTotal);
